...
-- Χρόνος δημιουργίας: 28 Φεβ 2015 στις 20:27:58
...
-- Δείκτες `attacks`
--
DROP TRIGGER IF EXISTS `attack_events`;
DELIMITER //
...
(1, 'Petrompeis', 'Mauromixalis', 'Mauromixalis', '1821', 0, '2.00', 1, 1, 1, 0, 0),
(2, 'Theodwros', 'Kolokotrwnis', 'Kolokotrwnis', '1821', 0, '3.00', 1, 1, 1, 0, 0),
(3, 'Andreas', 'Lontos', 'Lontos', '1821', 0, '1.00', 1, 1, 1, 0, 0),
(4, 'Laskarina', 'Mpoumpoulina', 'Mpoumpoulina', '1821', 0, '1.00', 1, 1, 1, 0, 0),
(5, 'Georgios', 'Papaflessas', 'Papaflessas', '1821', 0, '2.00', 1, 1, 1, 0, 0);
...
(1, 'Patra', '', 40, 40, 40, 40, 40, 40, 0, 36, 1, 240, 0, 0, 0, '1.00', -134, 314, 0, 0, 1, 1, 1, 0, 'Kalavruta,Vostitsa,Katw Axaia', 'Kalavruta,Karytaina,Korinthos,Lexaina,Purgos,Fanari,', 'Aigina,Androusa,Gastouni,Katw Axaia,Leontari,Lipovitsi,Megara,Prastos,Spetses,Tripolitsa', 'Agios Petros,Arkadia,Argos,Katw Naxagies,Korwni,Koutsouk Mani,Mani,Methwni,Emplakika,Monemvasia,Mystras,Navarino,Nauplio,Nhsi,Poros,Salamina,Skala,Ydra'),
