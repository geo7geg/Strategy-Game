...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2015 at 10:31 AM
...
(1, 'George', 'Gegos', 'geo7geg', '123', 0, 1, 1, 1, 1, 0, 0),
(2, 'Panagiotis', 'Chaldaios', 'panchal', '123', 0, 1, 1, 1, 1, 0, 0),
(3, 'Louis', 'Ragkousis', 'louisrag', '123', 0, 1, 1, 1, 1, 0, 0),
(4, 'Loukas', 'Korakitis', 'loukor', '123', 0, 1, 1, 1, 1, 0, 0),
(5, 'Mihalis', 'Koukos', 'mih_kouk', '123', 0, 1, 1, 1, 1, 0, 0);
...
INSERT INTO `regions` (`id`, `name`, `owner`, `farmcon`, `craftcon`, `dealercon`, `farm`, `craft`, `dealer`, `army`, `defence`, `level`, `revenue`, `cost`, `immune`, `offense`, `pol_stab`, `x`, `y`, `gold`, `cost_bill`, `reg_box`, `ini`, `box_id`, `def_fact`, `neighbor`) VALUES
(1, 'Patra', '', 40, 40, 40, 40, 40, 40, 0, 36, 1, 240, 0, 0, 0, '1.00', -134, 314, 0, 0, 1, 1, 1, 0, 'Kalavruta,Vostitsa,Katw Axaia'),
(2, 'Vostitsa', 'mih_kouk', 30, 40, 20, 30, 40, 20, 0, 27, 1, 170, 0, 0, 0, '1.00', -91, 309, 0, 0, 1, 0, 2, 0, 'Patra,Kalavruta,Korinthos,Katw Axaia'),
...
(4, 'Katw Axaia', '', 40, 30, 20, 40, 30, 20, 0, 27, 1, 160, 0, 0, 0, '1.00', -202, 269, 0, 0, 1, 0, 4, 0, 'Vostitsa,Patra,Kalavruta,Gastouni,Lexaina'),
(5, 'Lexaina', '', 20, 0, 10, 20, 0, 10, 0, 9, 1, 50, 0, 0, 0, '1.00', -253, 234, 0, 0, 1, 0, 5, 0, 'Katw Axaia,Gastouni'),
(6, 'Gastouni', '', 30, 10, 20, 30, 10, 20, 0, 18, 1, 110, 0, 0, 0, '1.00', -268, 188, 0, 0, 1, 0, 6, 0, 'Kalavruta,Fanari,Purgos,Katw Axaia,Lexaina,Lipovitsi'),
...
(9, 'Arkadia', 'panchal', 40, 30, 20, 40, 30, 20, 0, 36, 1, 160, 0, 0, 0, '1.00', -147, 21, 0, 0, 1, 0, 9, 0, 'Fanari,Androusa,Emplakika,Navarino,Leontari'),
...
(16, 'Mani', 'geo7geg', 40, 40, 10, 40, 40, 10, 0, 27, 1, 150, 0, 0, 0, '1.00', 29, -184, 0, 0, 2, 0, 6, 0, 'Koutsouk Mani,Mystras,Skala,Leontari'),
...
(22, 'Argos', '', 20, 15, 10, 20, 15, 10, 0, 14, 1, 80, 0, 0, 0, '1.00', 76, 139, 0, 0, 3, 0, 2, 0, 'Korinthos,Agios Petros,Nauplio,Tripolitsa'),
(23, 'Lipovitsi', 'louirag', 40, 20, 20, 40, 20, 20, 0, 24, 1, 140, 0, 0, 0, '1.00', -42, 116, 0, 0, 3, 0, 3, 0, 'Tripolitsa,Kalavruta,Gastouni,Karytaina'),
(24, 'Agios Petros', '', 30, 15, 0, 30, 15, 0, 0, 14, 1, 60, 0, 0, 0, '1.00', -72, 74, 0, 0, 3, 0, 4, 0, 'Tripolitsa,Argos,Mystras,Prastos,Spetses'),
...
(26, 'Spetses', 'loukor', 20, 30, 40, 20, 30, 40, 0, 27, 1, 200, 0, 0, 0, '1.00', 203, 23, 0, 0, 3, 0, 6, 0, 'Ydra,Nauplio,Katw Naxagies,Agios Petros,Prastos'),
...
(29, 'Aigina', '', 20, 10, 0, 20, 10, 0, 0, 9, 1, 40, 0, 0, 0, '1.00', 304, 183, 0, 0, 3, 0, 9, 0, 'Poros,Korinthos,Megara,Salamina'),
...
(36, 'Androusa', '', 40, 30, 20, 40, 30, 20, 0, 27, 0, 160, 0, 0, 0, '1.00', -125, -86, 0, 0, 0, 0, 0, 0, 'Arkadia,Korwni,Emplakika,Methwni,Navarino,Koutsouk Mani,Nhsi');
